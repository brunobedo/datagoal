...
%   Player's name
    ...
    for p = 1:size(playfull)
        ...
        players{p,1} = append('\leftarrow ',players{p,1});
    end
...
%   Comprimento
    ...
    p4 = plot(PlayersMeanX([MeanComp_x_min_c,MeanComp_x_max_c]),[0,0],'-R','LineWidth',2.5);
...
%   Largura
    ...
    p5 = plot([0,0],PlayersMeanY([MeanLarg_y_min_c,MeanLarg_y_max_c]),'-R','LineWidth',2.5);
