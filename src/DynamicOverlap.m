...
%   Dynamic overlap qd(t) was used to determine the region of the performer-environment state space explored by the players and the rate of exploration on different timescales. Dynamic overlap analysis allowed the slow dynamics on a long timescale (where playersï¿½
...
%   Ric A, Torrents C, Gonï¿½alves B, Torres-Ronda L, Sampaio J, Hristovski R. 
