...
%   <bruno.bedo@usp.br>
    ...
    %       Desvio padr�o da velocidade (m/s) 
...
%       Results
    ...
    tit =   {'Name','Total distance','Mean velocity','Standard Deviation velocity','Max Velocity','Max Acel','Max Desacel','Distance walking'...
    ...
    res =   [dist_total,med_vel,std_vel,max_vel,acelmax,desamax,d_range1,d_range2,d_range3,d_range4,d_range5,d_range6...
