...
% Author:   Bruno Luiz Souza Bedo <bruno.bedo@usp.br> 
    ...
    legend([p1a,p1b,p2a,p2b,p3a,p3b,pdm,pmf,pdf],...
    'Defensores','Centr�ide Defensores','Meio Campo','Centr�ide do Meio Campo',...
    'Atacantes','Centr�ide dos Atacantes','Dist�ncia entre Defensores e Maio Campistas',...
    'Dist�ncia entre Maio Campistas e Atacantes','Dist�ncia entre Defensores e Atacantes')
        %   Saving
