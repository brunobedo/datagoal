...
plot3([0 comp*0.16],[(larg/2)-comp*0.16 (larg/2)-comp*0.16],'w-','LineWidth',2);
plot3([16.5 16.5],[(larg/2)-20.16 (larg/2)+20.16],[8000 8000],'w-','LineWidth',2)

plot3([comp-comp*0.16 comp],[(larg/2)-comp*0.16 (larg/2)-comp*0.16],'w-','LineWidth',2);
plot3([comp-16.5 comp],[(larg/2)+20.16 (larg/2)+20.16],[8000 8000],'w-','LineWidth',2);
plot3([comp-16.5 comp-16.5],[(larg/2)-20.16 (larg/2)+20.16],[8000 8000],'w-','LineWidth',2);

%pequenas areas
plot3([comp*0.93 comp*0.93],[(larg/2)-comp*0.07 (larg/2)+comp*0.07],'w-','LineWidth',2);plot3([0 5.5],[(larg/2)+9.16 (larg/2)+9.16],[8000 8000],'w-','LineWidth',2);plot3([5.5 5.5],[(larg/2)-9.16 (larg/2)+9.16],[8000 8000],'w-','LineWidth',2)
plot3([comp-comp*0.07 comp],[(larg/2)-comp*0.07 (larg/2)-comp*0.07],'w-','LineWidth',2);plot3([comp-5.5 comp],[(larg/2)+9.16 (larg/2)+9.16],[8000 8000],'w-','LineWidth',2);plot3([comp-5.5 comp-5.5],[(larg/2)-9.16 (larg/2)+9.16],[8000 8000],'w-','LineWidth',2)
