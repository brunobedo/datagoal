...
elseif  hObject.Value == 2 
        ...
        ColNonLinearVariables = {' ',...
                            'Approximate entropy (ApEn) (1 team)',...
                            'Sample entropy (SampEn) (1 team)',...
                            'Shannon entropy (ShanEn) (1 team)',...
%                             'Dynamic overlap'};
                            };
...
elseif  hObject.Value == 3
        set(handles.NLColLinearAnalysisType,'Enable','on')
        ColNonLinearVariables = {' ',...
                            'Relative phase (2 teams)',...
                            'Windowed correlation (2 teams)',...
                            'Cross correlation (2 teams)',...
                            'Cross-sample entropy (Cross-SampEn) (2 teams)',...
                            'Vector coding (2 teams)',...
                            'Mutual information (2 teams)',...
                            'Cluster phase analysis (2 teams)',...
                            'Sectors Coordenation (1 team)',};
        set(handles.NLColLinearAnalysisType,'String',ColNonLinearVariables);
end
...
ColNonLinearTypeAll = {' ','Regularity','Synchronization'};
%   Linear
set(handles.TacticalComponentType,'Value',1)
set(handles.ColLinearAnalysisType,'Value',1); 
set(handles.ColLinearAnalysisType,'Enable','off')
...
if strcmp(selections.NLTacticalComponentType,'Regularity') 
switch selections.ColNonLinTyp
    case 'Approximate entropy (ApEn) (1 team)'
        disp(' ')
        ...
        disp('---------------------------------------------------')
    case 'Sample entropy (SampEn) (1 team)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
        ...
        disp(['Done: ', selections.ColNonLinTyp])
        disp('---------------------------------------------------')
    case 'Shannon entropy (ShanEn) (1 team)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
...
elseif strcmp(selections.NLTacticalComponentType,'Synchronization')  
    switch selections.ColNonLinTyp
    case 'Relative phase (2 teams)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
        ...
        disp(['Done: ', selections.ColNonLinTyp])
        disp('---------------------------------------------------')
    case 'Windowed correlation (2 teams)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
        ...
        disp(['Done: ', selections.ColNonLinTyp])
        disp('---------------------------------------------------')
    case 'Cross correlation (2 teams)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
        ...
        disp(['Done: ', selections.ColNonLinTyp])
        disp('---------------------------------------------------')
    case 'Cross-sample entropy (Cross-SampEn) (2 teams)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
    ...
    case 'Vector coding (2 teams)'
        ...
        disp(['Done: ', selections.ColNonLinTyp])
        disp('---------------------------------------------------')
    case 'Mutual information (2 teams)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
        ...
        disp(['Done: ', selections.ColNonLinTyp])
        disp('---------------------------------------------------')
    case 'Cluster phase analysis (2 teams)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
        ...
        disp(['Done: ', selections.ColNonLinTyp])
        disp('---------------------------------------------------')
    case 'Sectors Coordenation (1 team)'
        disp(' ')
        disp(['Calculating: ', selections.ColNonLinTyp])
