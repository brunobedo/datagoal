...
switch selections.ColLinTyp
    ...
    case 'Distância entre centroide de duas equipes'
        disp(' ')
        disp(['Calculating: ', selections.ColLinTyp])
        ResCompTeamCentroid = CompTeamsCentroid(selections.collectivedata);
    ...
    case 'Centroide por setores da equipe'
        disp(' ')
        disp(['Calculating: ', selections.ColLinTyp])
        ResCompSectCentroid = CompSectCentroid(selections.collectivedata);
    ...
    case 'Individual Playing Area (1 team)'
        disp(' ')
        disp(['Calculating: ', selections.ColLinTyp])
        ResIndividualPlayingArea = IndividualPlayingArea(selections.collectivedata);
...
elseif strcmp(selections.TacticalComponentType,'Comunicação de Ação')  
    ...
    case 'Vilars proposal'
        disp(' ')
        disp(['Calculating: ', selections.ColLinTyp])
        ResVilarsProposal = VilarsProposal(selections.collectivedata);
